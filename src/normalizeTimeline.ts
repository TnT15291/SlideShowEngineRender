...
const EFFECT_ALIASES: Record<string, string> = {
  ...
  portrait_reflection: "portrait_reflection",
  studio_reflection: "portrait_reflection",
  floor_reflection: "portrait_reflection",
  floating_card_gallery: "floating_card_gallery",
  floating_cards: "floating_card_gallery",
  moving_background_echo: "moving_background_echo",
  background_echo: "moving_background_echo",
  panel_flip: "panel_flip",
  flip_panel: "panel_flip",
  polaroid: "polaroid",
...
function normalizeSlide(s: any): any {
  ...
  const out: any = {
    id: s?.id,
    renderer: canonicalKey(s?.renderer) || "ffmpeg",
    template: s?.template,
