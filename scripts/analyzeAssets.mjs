...
const FONT_HINTS = {
  ...
  "Fraunces-Regular.ttf": {
    label: "Warm soft-contrast editorial serif",
    roles: ["title", "heading"],
    mood: ["warm", "organic", "nostalgic", "editorial"],
    summary: "VN-safe 2026-trend display serif for warm/nostalgic-film headings.",
    supportsVietnamese: true,
    readability: "medium",
  },
  "CormorantGaramond-Regular.ttf": {
    label: "Refined romantic serif",
    roles: ["title", "heading", "subtitle"],
    mood: ["romantic", "refined", "soft", "classic"],
    summary: "VN-safe delicate serif for soft ivory/editorial headings.",
    supportsVietnamese: true,
    readability: "medium",
  },
  "YesevaOne-Regular.ttf": {
    label: "Bold cinematic display serif",
    roles: ["title", "heading"],
    mood: ["bold", "dramatic", "cinematic"],
    summary: "VN-safe high-impact display serif for moody/cinematic headings.",
    supportsVietnamese: true,
    readability: "medium",
  },
  "AlexBrush-Regular.ttf": {
    ...
    roles: ["title", "accent"],
    mood: ["expressive", "romantic", "flowing"],
    summary: "VN-safe flowing brush script; renders Vietnamese diacritics correctly, unlike the older Latin-only scripts.",
    supportsVietnamese: true,
    readability: "low_for_long_text",
  },
  "Allura-Regular.ttf": {
    label: "Elegant flowing script",
    roles: ["title", "accent"],
    mood: ["elegant", "soft", "refined"],
    summary: "VN-safe refined script; renders Vietnamese diacritics correctly, unlike the older Latin-only scripts.",
    supportsVietnamese: true,
    readability: "low_for_long_text",
  },
  "Montserrat-Regular.ttf": {
    label: "Modern geometric sans",
    roles: ["heading", "subtitle", "body"],
    mood: ["modern", "geometric", "minimal"],
    summary: "VN-safe modern sans; the classic Playfair Display pairing partner, for minimal/modern headings.",
    supportsVietnamese: true,
    readability: "high",
  },
  "JosefinSans-Regular.ttf": {
    label: "Minimalist elegant sans",
    roles: ["accent", "subtitle", "heading"],
    mood: ["minimal", "elegant", "modern"],
    summary: "VN-safe thin geometric sans; the 'clean sans companion' to a bold serif headline (2026 editorial trend).",
    supportsVietnamese: true,
    readability: "high",
  },
  "Merienda-Regular.ttf": {
    label: "Casual handwritten script",
    roles: ["title", "accent"],
    mood: ["casual", "handwritten", "nostalgic", "playful"],
    summary: "VN-safe rounded handwriting script for home-movie/scrapbook nostalgia.",
    supportsVietnamese: true,
    readability: "medium_for_short_text",
  },
};
